...
public class ImageClassifierHDD {
    ...
    private static boolean doApplyModel = true;  // should we apply a learned model to some data?
    private static boolean doLearn = false;  // should we learn a model from training data?
