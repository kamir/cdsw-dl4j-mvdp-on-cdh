...
/**
 * ImagePersister are used to translate between multiple data representations.
 *
 * Examples:
 *
 *
 * (A)  INDArray -> File on disc
 * (B)  Solr-Document => feature vector
 * (C)  File - Metadata => feature vector
 * (D)  PNG => feature vector
 * etc.
 *
 */
public class ImagePersister {
    ...
    public static void writeIndarrayAsImageToDisk(INDArray array, File file) {
